...
const SideOrder = () => {
  ...
  return (
    <>
          ...
          <ul className="">
            ...
            {carts.map((cart, index) => (
              <li
                ...
                className={`flex mt-2 justify-center items-center w-24 h-24 border rounded-full border-gray-500 hover:cursor-pointer ${index === selectedCart.client ? "bg-cyan-700" : ""
                  }`}
                key={index}
              >
      ...
      <CheckoutDialog
        checkoutDialogIsOpen={checkoutDialogIsOpen}
        onCloseDialog={() => {
